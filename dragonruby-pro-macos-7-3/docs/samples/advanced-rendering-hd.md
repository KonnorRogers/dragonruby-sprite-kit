...
### Hd Max Scale Configurations - main.rb
```ruby
  # ./samples/07_advanced_rendering_hd/03_hd_max_scale_configurations/app/main.rb
  module Main
    def tick args
...
### Multi Platform Multi Orientation - main.rb
```ruby
  # ./samples/07_advanced_rendering_hd/06_multi_platform_multi_orientation/app/main.rb
